...
public interface ISnrParametricasRepo extends IGenericRepo<SnrParametrica, Integer> {
	...
	public Void programarJob(@Param("idJob") Integer idJob, @Param("fecEjecucion") String fecEjecucion,
	...
	public Integer cancelarJob(@Param("idJob") Integer idJob, @Param("usuario") String usuario);
	...
	public List<Object[]> detalleProceso(@Param("idProceso") Integer idProceso);
	...
	public List<Object[]> historicoProceso(@Param("idProceso") Integer idProceso);
